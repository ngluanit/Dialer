...
import com.android.sms.CrashlyticsTree
...
class QKApplication : Application(), HasActivityInjector, HasBroadcastReceiverInjector, HasServiceInjector {
    ...
    override fun onCreate() {
        ...
        ExtensionsFactory.init(applicationContext)
        Trace.endSection()
        BlockedNumbersAutoMigrator(PreferenceManager.getDefaultSharedPreferences(this),
                FilteredNumberAsyncQueryHandler(contentResolver)).autoMigrate()
        Trace.endSection()
